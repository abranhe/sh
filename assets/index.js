...
function detect_platform() {
  ...
  if (navigator.platform == 'Linux i686 on x86_64') {
    os = 'unix';
  }
  if (navigator.platform == 'Linux aarch64') {
    os = 'unix';
  }
  if (navigator.platform == 'Linux armv6l') {
    os = 'unix';
  }
  ...
  if (navigator.platform == 'Linux ppc64') {
    os = 'unix';
  }
  if (navigator.platform == 'Linux mips') {
    os = 'unix';
  }
  if (navigator.platform == 'Linux mips64') {
    os = 'unix';
  }
  ...
  if (navigator.platform == 'FreeBSD x86_64') {
    os = 'unix';
  }
  if (navigator.platform == 'FreeBSD amd64') {
    os = 'unix';
  }
  if (navigator.platform == 'NetBSD x86_64') {
    os = 'unix';
  }
  if (navigator.platform == 'NetBSD amd64') {
    os = 'unix';
  }
  ...
  if (navigator.oscpu) {
    ...
    if (navigator.oscpu.indexOf('FreeBSD') != -1) {
      os = 'unix';
    }
    if (navigator.oscpu.indexOf('NetBSD') != -1) {
      os = 'unix';
    }
  }
